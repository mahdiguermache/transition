    ...
    plugins: [
      ...
      new webpack.DefinePlugin({
        'process.env': {
          ...
          'MAPLIBRE_ACCESS_TOKEN'       : JSON.stringify(process.env.MAPLIBRE_ACCESS_TOKEN),
          'MAPLIBRE_USER_ID'            : JSON.stringify(process.env.MAPLIBRE_USER_ID || config.maplibreUserId),
          'MAPLIBRE_STYLE_ID'           : JSON.stringify(process.env.MAPLIBRE_STYLE_ID || config.maplibreStyleId),
